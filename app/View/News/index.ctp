                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab">
                       ...
                       <?php foreach ($list as $key=>$item):?>
                		 <tr align="center" id="<?php echo $item['id']?>">
                            ...
                            <td>[ <a href="/News/add?nid=<?php echo $item['id']?>">头图设置 </a> ]  [ <a href="/News/add?nid=<?php echo $item['id']?>">编辑 </a> ] [ <a link="/News/del?nid=<?php echo $item['id']?>" href="javascript:void(0)" name="<?php echo $item['title']?>" class="del">删除 </a> ]</td>
                		 </tr>
               		 <?php endforeach;?>
		                  <tr>
   ...
   <script type="text/javascript">
            ...
            function changeAttr(id,type,v){ //设置推荐
            	$.ajax({
        		    ...
        		    dataType:'json',
        		    url:"/News/changeAttr",
        		    data:"nid="+id+"&types="+type+"&a="+Math.random(),
