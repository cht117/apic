     <?php echo $this->element('banner');?>
      <div class="sxyjy_mbx">
                    <span><a href="/Index/index">首页</a> ><a href="/Shensource/index"><?php echo $btitle ;?></a>  > <i><a href="<?php echo '/'.$module.'/'.$action;?>"><?php echo $stitle;?></a></i>> <i><?php echo $news['title'];?></i></span>
                </div>
