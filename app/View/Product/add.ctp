			...
			<div class="Item hr">
                    ...
                    <form>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table1">
                        	<tr>
                        		 <td><input type="hidden" name="act" value="<?php if(!empty($data['pid'])):?>edit<?php else:?>add<?php endif;?>" /></td>
                        	</tr>
                            <tr>
                            ...
                            <td>
                                <select name="info[rid]" id="guide">
                                    ...
                                    <?php foreach ($goodsdata as $key=>$item):?>
                                    		<option value="<?php echo $item['id']?>" <?php if($info['rid']==$item['id']){echo 'selected="selected"'; }?>><?php echo $item['title']?></option>
                                    <?php endforeach;?>
                                </select>
                            </td>
                       		</tr>
                ...
                $("#checkNewsTitle").click(function(){
                    ...
                    $.getJSON("/Product/checkProductTitle", { title:$("#title").val(),id:"<?php echo isset($info['id'])?$info['id']:'';?>"}, function(json){
