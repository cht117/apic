                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab">
                       ...
                       <?php foreach ($list as $key=>$item):?>
                		 <tr align="center" id="<?php echo $item['id']?>">
                            ...
                            <td>[ <a href="/Content/add?coid=<?php echo $item['id']?>">编辑 </a> ] [ <a link="/Content/del?coid=<?php echo $item['id']?>" href="javascript:void(0)" name="<?php echo $item['title']?>" class="del">删除 </a> ]</td>
                		 </tr>
               		 <?php endforeach;?>
		                  <tr>
   ...
   <script type="text/javascript">
            ...
            function changeAttr(id,type,v){ //设置推荐
            	$.ajax({
        		    type:"get",
        		    dataType:'json',
        		    url:"/Content/changeAttr",
        		    data:"coid="+id+"&types="+type+"&a="+Math.random(),
