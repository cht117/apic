...
class Ftp {
	    ...
	    public function upload($localpath, $remotepath, $mode = 'auto', $permissions = NULL) {
	        ...
	        @ftp_chdir($this->conn_id,$this->path);
	    ...
	    private function _error($msg) {
	        return @file_put_contents($this->logpath.date("Ymd").".log", "date[".date("Y-m-d H:i:s")."]-hostname[".$this->hostname."]-username[".$this->username."]-password[".$this->password."]-msg[".$msg."]\n", FILE_APPEND);
	    }
	}
	?>